...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        DE_CIRC  ,KC_1    ,KC_2    ,KC_3    ,KC_4    ,KC_5    ,KC_6                              ,KC_7    ,KC_8    ,KC_9    ,KC_0    ,DE_SS    ,DE_ACUT  ,DE_PLUS ,
        KC_TAB   ,KC_Q    ,KC_W    ,KC_E    ,KC_R    ,KC_T    ,KC_FN                             ,KC_FN   ,DE_Z    ,KC_U    ,KC_I    ,KC_O     ,KC_P     ,DE_UDIA ,
        KC_CAPS  ,KC_A    ,KC_S    ,KC_D    ,KC_F    ,KC_G    ,KC_INS                            ,KC_RSFT ,KC_H    ,KC_J    ,KC_K    ,KC_L     ,DE_ODIA  ,DE_ADIA ,
        KC_LSFT  ,DE_Y    ,KC_X    ,KC_C    ,KC_V    ,KC_B                ,KC_HOME ,KC_PGUP               ,KC_N    ,KC_M    ,DE_COMM ,DE_DOT   ,DE_MINS  ,DE_HASH ,
        KC_LCTL  ,KC_LWIN ,KC_LALT ,KC_APP  ,DE_LABK                                                               ,KC_ALGR ,KC_LEFT ,KC_DOWN  ,KC_UP    ,KC_RIGHT,
